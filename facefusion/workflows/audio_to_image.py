...
from facefusion.audio import count_trim_audio_frame_total, create_empty_audio_frame, get_audio_frame, get_voice_frame
...
from facefusion.vision import conditional_merge_vision_mask, detect_image_resolution, extract_vision_mask, pack_resolution, read_static_image, read_static_images, restrict_trim_frame, scale_resolution, write_image
...
def process_image() -> ErrorCode:
	state_manager.set_item('output_video_fps', 25.0) # TODO
	source_audio_path = get_first(filter_audio_paths(state_manager.get_item('source_paths')))
	audio_frame_total = count_trim_audio_frame_total(source_audio_path, state_manager.get_item('output_video_fps'), state_manager.get_item('trim_frame_start'), state_manager.get_item('trim_frame_end'))
	temp_frame_paths = get_temp_frame_sequence_paths(state_manager.get_item('output_path'), audio_frame_total, '%08d')
